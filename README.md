...
## 📽️ See it in Action
[![Auto Job Applier demo video](https://github.com/niyas-softdev/assets/100998531/429f7753-ebb0-499b-bc5e-5b4ee28c4f69)](https://youtu.be/gMbB1fWZDHw)
...
4. Clone the current git repo or download it as a zip file, url to the latest update https://github.com/niyas-softdev.
...
6. If you have questions or need help setting it up or to talk in general, join the github server: none
...
8. If you have questions or need help setting it up or to talk in general, join the github server: none
...
### Code Guidelines
  ...
  New feature example
  ```python
  ##> ------ AI ML Developer : niyas-softdev - Feature ------
  ...
  ##> ------ AI ML Developer :aiml.developer@gmail.com - Bug fix ------
...
- Email     : aiml.developer@gmail.com
...
Copyright (C) 2024 AI ML Developer  <saivigneshgolla@outlook.com>
...
- **LinkedIn** : https://www.linkedin.com/in/softdev-niyas/
- **Email**    :aiml.developer@gmail.com
- **X/Twitter**: aiml.developer@gmail.com
- **Discord**  : niyas-softdev
...
alternate link: none
- **GitHub**
    - [All Discussions](https://github.com/niyas-softdev/discussions)
    - [Announcements](https://github.com/niyas-softdev/discussions/categories/announcements)
    - [General](https://github.com/niyas-softdev/discussions/categories/general)
    - [Feature requests or Ideas](https://github.com/niyas-softdev/discussions/categories/feature-requests-or-ideas)
    - [Polls](https://github.com/niyas-softdev/discussions/categories/polls)
    - [Community Flex](https://github.com/niyas-softdev/discussions/categories/community-flex)
    - [Support Q&A](https://github.com/niyas-softdev/discussions/categories/support-q-a)
