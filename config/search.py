...
search_terms = ["Data Engineer", "Software Developer", "Python Developer", "Ai intern", "SQL Developer", "Front End Developer", "Data analyst", "Data Ai intern", "Machine Learning engineer","data analyst intern"]
